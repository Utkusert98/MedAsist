export const ilaclar = [
  ...
  // TAKVİYELER (YENİ EKLENDİ)
  {
    ...
    resim: "/ilaclar/solgar.jpg",
    uyari: false
  },
  {
    id: 31,
    ad: "Ocean Vitamin D3K2",
    etkenMadde: "Vitamin D3K2",
    kategori: "Takviye",
    neIseYarar: "Güneş görmüyorsan, kemiklerin sızlıyorsa D vitamini takviyesidir.",
    resim: "/ilaclar/ocean-d3k2.jpg",
    uyari: false
  },
  {
    id: 32,
    ad: "Nutraxin Artroflex",
    etkenMadde: "Glucosamine Chondroitin MSM",
    kategori: "Takviye",
    neIseYarar: "Diz ağrıların, eklem ağrıların varsa en etkili takviyedir.",
    resim: "/ilaclar/nutraxin-artroflex.jpg",
    uyari: false
},
  // ANTİBİYOTİK (UYARILI)
  {
